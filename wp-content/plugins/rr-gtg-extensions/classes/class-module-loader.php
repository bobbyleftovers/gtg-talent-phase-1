...
class FL_Custom_Modules_Example_Loader {
	...
	static public function load_modules() {
		// require_once RRBB_MODULE_DIR . 'modules/basic-example/basic-example.php';
		// require_once RRBB_MODULE_DIR . 'modules/example/example.php';
		require_once RRBB_MODULE_DIR . 'modules/slider/slider.php';
	}
	...
	static public function register_fields( $fields ) {
		$fields['my-custom-field'] = RRBB_MODULE_DIR . 'fields/my-custom-field.php';
		return $fields;
	}
	...
	static public function enqueue_field_assets() {
		...
		// wp_enqueue_style( 'my-custom-fields', RRBB_MODULE_URL . 'assets/css/fields.css', array(), '' );
		// wp_enqueue_script( 'my-custom-fields', RRBB_MODULE_URL . 'assets/js/fields.js', array(), '', true );
	}
}
